                                                ...
                                                return  <tr key={j}>
                                                            {
                                                                this.state.columns.map((column, i) => {   
                                                                    return <td key={i}>
                                                                                ...
                                                                                {(column.Cell) && (!column.child_accessor) &&
                                                                                    column.Cell(data[column.accessor])
                                                                                }
                                                                                {(column.Cell) && (column.child_accessor) &&  (!column.child_accessor_2) &&
                                                                                    column.Cell({value : data[column.accessor], id: data[column.child_accessor]})
                                                                                }
                                                                                {(column.Cell) && (column.child_accessor) && (column.child_accessor_2) &&
                                                                                    column.Cell({value : data[column.accessor], id: data[column.child_accessor], id2: data[column.child_accessor_2]})
                                                                                }
                                                                    ...
                                                                    {child.hidden === 'no' &&
                                                                        <div className="form-group row" key={j}>
                                                                            ...
                                                                            <div className="col-sm-12 col-md-6">
                                                                                ...
                                                                                {child.type === 'file' && child.content_text === 'text' && child.hidden === 'no' &&
                                                                                    <input className="form-control" type="file" id={child.id} name={child.id} 
                                                                                    />
                                                                                }
