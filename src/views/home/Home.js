    ...
    render(){
        return(
            <div className="home-slider">
                ...
                <div className="df-logo-initial mg-b-15"><p>sva</p></div>
                <p className="home-text">Simple Voting Web Application</p>

                <h6 className="home-headline">Thi App built with reactjs and laravel for API. I Build that <span>With My Heart</span> and <span>My Time</span> While I'm still single. :v</h6>

                <div className="d-flex wd-lg-350">
                <a href="https://www.facebook.com/mochamad.idris" className="btn btn-brand-01 flex-fill btn-icon"><i className="fab fa-facebook"> Facebook</i></a>
                <a href="https://www.instagram.com/muhammadrifaiidris/" className="btn btn-white flex-fill mg-l-10"><i className="fab fa-instagram"> Instagram</i></a>
                </div>
                ...
                <div className="tx-color-03 pd-l-10" data-toggle="tooltip" data-title="Coming soon"><i className="fab fa-laravel"></i></div>
                <div className="tx-color-03 pd-l-10" data-toggle="tooltip" data-title="Coming soon"><i className="fab fa-microsoft"></i></div>
