...
class Candidat extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      id_selected: '',
      modal_upload: true,
      url: { url_get_data : `/period/${this.props.match.params.id}/candidat`, url_save_data: '/candidat_period', url_update_data: '/candidat_period',  
             url_delete_data: '/candidat_period', url_get_data_per: '/candidat_period' },
      title: 'Data Kandidat Per Periode', 
      title_add : 'Add Data Kandidat', 
      fields: data_field.data, 
      columns: [ 
        { header: 'Nama Lengkap', id: 'nama_lengkap', accessor: 'candidat', child_accessor: 'nama_lengkap', className: 'text-center'},
        { header: 'Tempat Lahir', id: 'tempat_lahir', accessor: 'candidat', child_accessor: 'tempat_lahir', className: 'text-center'},
        { header: 'Tgl. Lahir', id: 'tgl_lahir', accessor: 'candidat', child_accessor: 'tgl_lahir', className: 'text-center'},
        // { header: 'Alamat', id: 'alamat', accessor: 'alamat', child_accessor: null, className: 'text-center'},
        { header: 'Agama', id: 'agama', accessor: 'candidat', child_accessor: 'agama', className: 'text-center'},
        { header: 'Pekerjaan', id: 'pekerjaan', accessor: 'candidat', child_accessor: 'pekerjaan', className: 'text-center'},
        // { header: 'KTP', id: 'no_ktp', accessor: 'no_ktp', child_accessor: null, className: 'text-center'},
        { header: 'Warga Negara', id: 'warga_negara', accessor: 'candidat', child_accessor: 'warga_negara', className: 'text-center'},
