        ...
        return(
            <div className="App">
                ...
                <div className="navbar-brand">
                    <a href="!#" className="df-logo">simple<span>vote</span></a>
                </div>
                </header>
                        ...
                        <div className="media align-items-stretch justify-content-center ht-100p pos-relative">
                            <div className="sign-wrapper mg-lg-l-50 mg-xl-l-60">
                                <div className="wd-100p">
                                    <h3 className="tx-color-01 mg-b-5 text-center">Sign In</h3>
                                    <p className="tx-color-03 tx-16 mg-b-40 text-center">Simple Voting Web Application Just For Fun</p>
